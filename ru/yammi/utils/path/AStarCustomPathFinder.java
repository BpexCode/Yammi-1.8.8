...
public class AStarCustomPathFinder {
    ...
    private static boolean isBlockSolid(BlockPos block) {
        return getBlock(block.getX(), block.getY(), block.getZ()).isFullCube() ||
                (getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockSlab) ||
                (getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockStairs)||
                (getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockCactus)||
                (getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockChest)||
                (getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockEnderChest)||
                (getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockSkull)||
                (getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockPane)||
                (getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockFence)||
                (getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockWall)||
                (getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockGlass)||
                (getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockPistonBase)||
                (getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockPistonExtension)||
                (getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockPistonMoving)||
                (getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockStainedGlass)||
                (getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockTrapDoor);
    }
    ...
    private static boolean isSafeToWalkOn(BlockPos block) {
        return !(getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockFence) &&
                !(getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockWall);
    }
